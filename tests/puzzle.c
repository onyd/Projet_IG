...
static char *k_default_image_filename = "misc/montagne.png";
...
void create_puzzle_window(char *image_filename) {
    ...
    puzzle = (puzzle_t *) calloc(1, sizeof(*puzzle));
    ...
    puzzle->n = n;
    puzzle->tiles = (tile_t *) calloc(n.width * n.height, sizeof(tile_t));
    puzzle->current = (tile_t **) calloc(n.width * n.height, sizeof(tile_t *));
