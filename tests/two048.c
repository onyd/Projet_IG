...
void create_window(game_t *g) {
    ...
    toplevel_size = ei_size(g->nb_tile_x * tile_fullsize.width + 2 * g->tile_bd,
                            g->nb_tile_y * tile_fullsize.height + 2 * g->tile_bd);
    ei_toplevel_configure(g->toplevel, &toplevel_size, &g_bd_col, &toplevel_border, &toplevel_title, NULL,
    ...
    for (y = 0; y < g->nb_tile_y; y++) {
        ...
        for (x = 0; x < g->nb_tile_x; x++) {
            ...
            ei_frame_configure(tile_bg, &tile_bg_size, &g_bg_col, &tile_bg_borderwidth, NULL, NULL, NULL, NULL, NULL,
                               NULL, NULL, NULL);
